...
class GsonBinder : Binding<Any, JsonElement> {
  // The converter does all the work
  override fun converter() = object : Converter<Any, JsonElement> {
    override fun from(t: Any?) = if (t == null) JsonNull.INSTANCE else Gson().fromJson(
      "" + t,
      JsonElement::class.java
    )

    override fun to(u: JsonElement?) = if (u == null || u === JsonNull.INSTANCE) null else Gson().toJson(u)

    override fun fromType() = Any::class.java
    override fun toType() = JsonElement::class.java
  }

  // Rending a bind variable for the binding context's value and casting it to the json type
  @Throws(SQLException::class)
  override fun sql(ctx: BindingSQLContext<JsonElement>) { // Depending on how you generate your SQL, you may need to explicitly distinguish
