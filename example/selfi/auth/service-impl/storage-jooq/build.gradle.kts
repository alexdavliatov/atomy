...
val dbUrl = System.getProperty("dbUrl") ?: "jdbc:postgresql://dockerhost:9992/auth_dev"
val dbUser = System.getProperty("dbUser") ?: "auth_admin"
val dbPassword = System.getProperty("dbPassword") ?: "yIe7fq4h#k!Ktn&shDo5r@Jt"
...
jooq {
  ...
  "auth"(java.sourceSets["main"]!!) {
    ...
    generator {
      ...
      target {
        packageName = "ru.adavliatov.atomy.example.selfie.auth.service.repo.generated"
...
dependencies {
  api(project(":example:selfi:auth:service"))
